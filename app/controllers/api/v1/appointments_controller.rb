module Api
  module V1
    class AppointmentsController < ApplicationController
      ...
      def create
        @appointment = @current_user.appointments.create(date: appointment_params[:date], item_id: appointment_params[:item_id], branch: appointment_params[:branch])
      ...
      def update
        if @appointment.update(date: appointment_params[:date], item_id: appointment_params[:item_id], branch: appointment_params[:branch])
          render json: @appointment, status: 200
        else
